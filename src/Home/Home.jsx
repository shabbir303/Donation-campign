...
const Home = () => {
  ...
  return (
    <div >
      ...
      <div className="hero min-h-[300px] lg:min-h-[500px]  relative bg-[url(https://i.ibb.co/QmRtn1n/fc1f79e18cdc1a12320b9b10ec3e253d.jpg)] opacity-10  ">

      </div>
      <h1 className="  text-center md:text-center lg:text-center mt-[-230px]  lg:mt-[-400px] right-[10px] md:left-[80px]  left-[30px]  lg:left-[550px]  lg:right-[500px] z-10 absolute text-[25px] font-[700] lg:text-[48px] lg:font-[700] ">I Grow By Helping People In Need</h1>
      <div className=" flex flex-row lg:flex-row items-center mt-[-130px] lg:mt-[-300px] right-[50px] md:right-[250px] lg:right-[700px]  absolute">
