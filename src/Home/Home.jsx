...
const Home = () => {
  ...
  return (
    <div >
      ...
      <h1 className=" mt-[-280px]   lg:mt-[-400px] right-[10px] md:left-[200px]  left-[30px]  lg:left-[550px]  lg:right-[500px] z-10 absolute text-[25px] font-[700] lg:text-[48px] lg:font-[700] ">I Grow By Helping People In Need</h1>
      <div className=" flex flex-row lg:flex-row items-center mt-[-200px] lg:mt-[-300px] right-[50px] md:right-[270px] lg:right-[750px]  absolute">
